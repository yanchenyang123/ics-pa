...
//cuo de you    if-else  movsx  mul-longlong
//huaiyi de zhi ling you B_type zhongde
  ...
  INSTPAT("??????? ????? ????? 111 ????? 11000 11", bgeu   , B, s->dnpc+=((word_t)src1>=(word_t)src2? imm-4:0));
  //r_type
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , r, R(dest)=(int)(((long long int)src1*(long long int)src2)>>32));  //X
