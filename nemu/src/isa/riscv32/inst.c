...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , r, long long int t=(int)src1;t*=(int)src2;R(dest)=(t>>32));  //X
  ...
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , r, unsigned long int t=(word_t)src1;t*=(word_t)src2;R(dest)=(t>>32));
  //S_type
